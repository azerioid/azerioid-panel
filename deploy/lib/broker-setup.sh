...
install_broker() {
    ...
    touch /var/log/lacmp-panel/php-fpm.log /var/log/lacmp-panel/auth-fail.log
    chown "${WEB_USER}:${WEB_USER}" /var/log/lacmp-panel/php-fpm.log /var/log/lacmp-panel/auth-fail.log
    chmod 0640 /var/log/lacmp-panel/php-fpm.log /var/log/lacmp-panel/auth-fail.log
    ...
    local sudoers=/etc/sudoers.d/lacmp-panel
    cat > "${sudoers}" <<EOF
# Stack Manager — sudoers (generated by install.sh)
...
# Stack Manager — Laravel scheduler
SHELL=/bin/sh
